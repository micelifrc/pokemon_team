...
void Pokedex::make(unsigned regions, unsigned tipologies) {
   ...
   if (RegionsFlag::KANTO & regions) {
      if (TypologyFlag::STARTERS & tipologies) {
         if (TypologyFlag::PREEVOLUTIONS & tipologies) {
         ...
         if (TypologyFlag::MEGAS & tipologies) {
      ...
      if (TypologyFlag::PREEVOLUTIONS & tipologies) {
         ...
         if (TypologyFlag::ALOLAFORMS & tipologies) {
      ...
      if ((TypologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::JOHTO & regions)) {
      ...
      if ((TypologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::SINNOH & regions)) {
      ...
      if (TypologyFlag::LEGENDARIES & tipologies) {
      ...
      if (TypologyFlag::PSEUDOLEGENDARIES & tipologies) {
      ...
      if (TypologyFlag::MYSTERIOUS & tipologies) {
   ...
   if (RegionsFlag::JOHTO & regions) {
      ...
      if ((TypologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::KANTO & regions)) {
   ...
   if (RegionsFlag::SINNOH & regions) {
      ...
      if ((TypologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::HOENN & regions)) {
   ...
   if (RegionsFlag::ALOLA & regions) {
      ...
      if (TypologyFlag::ULTRACREATURES & tipologies) {
