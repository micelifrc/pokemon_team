...
void Pokedex::make(unsigned regions, unsigned tipologies) {
   ...
   if (RegionsFlag::KANTO & regions) {
      if (TipologyFlag::STARTERS & tipologies) {
         ...
         if (TipologyFlag::MEGAS & tipologies) {
      ...
      if (TipologyFlag::PREEVOLUTIONS & tipologies) {
         ...
         if (TipologyFlag::ALOLAFORMS & tipologies) {
      ...
      if ((TipologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::JOHTO & regions)) {
      ...
      if ((TipologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::SINNOH & regions)) {
      ...
      if (TipologyFlag::LEGENDARIES & tipologies) {
      ...
      if (TipologyFlag::PSEUDOLEGENDARIES & tipologies) {
      ...
      if (TipologyFlag::MYSTERIOUS & tipologies) {
   ...
   if (RegionsFlag::JOHTO & regions) {
      ...
      if ((TipologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::KANTO & regions)) {
   ...
   if (RegionsFlag::SINNOH & regions) {
      ...
      if ((TipologyFlag::PREEVOLUTIONS & tipologies) or not(RegionsFlag::HOENN & regions)) {
   ...
   if (RegionsFlag::ALOLA & regions) {
      ...
      if (TipologyFlag::ULTRACREATURES & tipologies) {
